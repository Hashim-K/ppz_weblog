    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Configure parser and visualization options</p>
        </div>
      ...
      {/* Message */}
      {message && (
        <Card className={`border-l-4 ${message.includes('success') ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'}`}>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium">Max Message Size (bytes)</label>
              <Input
                type="number"
                value={settings.parser.max_message_size}
                onChange={(e) => updateParserSetting('max_message_size', parseInt(e.target.value))}
              />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium">Time Offset (seconds)</label>
              <Input
                type="number"
                step="0.1"
                value={settings.parser.time_offset}
                onChange={(e) => updateParserSetting('time_offset', parseFloat(e.target.value))}
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateParserSetting('skip_unknown_messages', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateParserSetting('parse_debug_messages', checked)}
              />
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateVisualizationSetting('max_points_per_plot', parseInt(e.target.value))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateVisualizationSetting('time_window_seconds', parseFloat(e.target.value))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateVisualizationSetting('refresh_interval', parseFloat(e.target.value))}
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateVisualizationSetting('auto_refresh', checked)}
            />
          </div>
        </CardContent>
      </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateExportSetting('decimal_places', parseInt(e.target.value))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => updateExportSetting('time_format', e.target.value)}
              >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateExportSetting('include_raw_data', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateExportSetting('include_metadata', checked)}
              />
            </div>
          </div>
        </CardContent>
